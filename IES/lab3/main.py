...
def response_to_request(processed_agent_data: ProcessedAgentData):
    redis_client.lpush(
...
async def save_processed_agent_data(processed_agent_data: ProcessedAgentData):
    ...
    return response_to_request(processed_agent_data)
...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        response_to_request(processed_agent_data)
